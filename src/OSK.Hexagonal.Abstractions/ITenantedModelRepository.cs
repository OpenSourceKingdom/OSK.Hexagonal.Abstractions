...
{
    public interface ITenantedModelRepository<TTenantId, TId, TModel>
        ...
        where TModel : ITenantedModel<TTenantId, TId>
    {
        ...
        Task<IOutput<TModel>> GetAsync(TTenantId tenantId, TId id, CancellationToken cancellationToken = default);
